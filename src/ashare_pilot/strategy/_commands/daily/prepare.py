...
from ashare_pilot.mapping._commands.daily.validate_mapper import check_doc as validate_mapper
...
def fetch_indices(path: Path | None) -> tuple[dict[str, dict[str, Any]], float, bool]:
    ...
    if path:
        ...
        data = fetch_quotes(INDEX_CODES, workspace=current_workspace())
