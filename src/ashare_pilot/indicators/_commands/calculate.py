...
from ashare_pilot.market_data._commands.history import fetch_history, to_csv
from ashare_pilot.market_data._datasources.utils import RANGE_PATTERN
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        default="3m",
        help="Time range: positive integer + d/w/m/y (default: 3m)",
    )
    parser.add_argument(
        "--start",
