...
from build_theme_evidence_input import build_input  # noqa: E402
from build_theme_stocks_base import merge_extra_stock, stock_template  # noqa: E402
from build_theme_stocks_universe import enrich_structured_source_flags  # noqa: E402
from build_step2_timing import update_report  # noqa: E402
from compare_step2_regression import classify_changes, diff, normalized  # noqa: E402
from mapper_json_lib import (build_deterministic_mapper_base, deterministic_pattern,
                             merge_annotations, publish_theme_stocks)  # noqa: E402
from prepare_daily_mapping import annotation_input  # noqa: E402
from validate_mapper_annotations import validate, validate_candidate_coverage, validate_news_refs  # noqa: E402
...
class FrozenGateTests(unittest.TestCase):
    def test_dated_frozen_gate_cases(self):
        fixture_path = Path(__file__).parent / "fixtures" / "step2_frozen_gates.json"
    ...
    def test_2026_07_14_market_source_correction_audit_is_complete(self):
        path = Path(__file__).parent / "fixtures" / "2026-07-14-market-source-corrections.json"
