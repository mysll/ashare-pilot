...
from lib.datasources.sina import SinaDataSource
...
class SinaCacheTests(unittest.TestCase):
    @patch("lib.datasources.sina.save_cache")
    @patch("lib.datasources.sina.load_cache")
    @patch("lib.datasources.sina.datetime", FixedDateTime)
    ...
    @patch("lib.datasources.sina.cache_checked_recently", return_value=True)
    @patch("lib.datasources.sina.load_cache")
    @patch("lib.datasources.sina.datetime", FixedDateTime)
    ...
    @patch("lib.datasources.sina.save_cache")
    @patch("lib.datasources.sina.load_cache")
    @patch("lib.datasources.sina.datetime", FixedAfterCloseDateTime)
