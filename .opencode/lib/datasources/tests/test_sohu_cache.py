...
from lib.datasources.sohu import SohuDataSource
...
class SohuCacheTests(unittest.TestCase):
    ...
    @patch("lib.datasources.sohu.save_cache")
    @patch("lib.datasources.sohu.load_cache")
    ...
    @patch("lib.datasources.sohu.cache_checked_recently", return_value=True)
    @patch("lib.datasources.sohu.save_cache")
    @patch("lib.datasources.sohu.load_cache")
    ...
    @patch("lib.datasources.sohu.save_cache")
    @patch("lib.datasources.sohu.load_cache", return_value=None)
